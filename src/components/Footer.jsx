    ...
    return (
        <footer className="mt-8 md:mt-10 lg:mt-16 py-5 md:py-8 lg:py-10">
            <div className="container p-6 mx-auto">
                <div className="lg:flex">
                    <div className="w-full -mx-6 lg:w-2/5">
                        <div className="px-6">
                            ...
                            Join our community and stay connected for exclusive offers, new arrivals, and more. Wear your story with AttireAvenue.
                            </p>

                            <div className="flex mt-6 -mx-2 gap-5">
                                <a className="text-xl" data-tooltip-id="fb-page" data-tooltip-content="https://www.facebook.com/AttireAvenue" 
                                data-tooltip-place="bottom">
                                    <FaFacebookF />
                                </a>
                                <Tooltip id="fb-page"/>
                                
                                <a className="text-xl" data-tooltip-id="twitter-page" data-tooltip-content="https://www.twitter.com/AttireAvenue"
                                    data-tooltip-place="bottom">
                                    <FaTwitter />
                                </a>
                                <Tooltip id="twitter-page" />

                                <a className="text-xl" data-tooltip-id="instagram-page" data-tooltip-content="https://www.instagram.com/AttireAvenue"
                                    data-tooltip-place="bottom">
                                    <FaInstagram />
                                </a>
                ...
                <div>
                    <p className="text-center text-gray-500 ">© AttireAvenue 2024 - All rights reserved</p>
                </div>
            </div>
        </footer>
    );
